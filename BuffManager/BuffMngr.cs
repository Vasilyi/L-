...
namespace BuffMngr
{
    public class Program
    {
        ...
        private static void BuffGained(Obj_AI_Base target, Obj_AI_Base source, Program.OnGainBuffArgs args)
        {
            Console.WriteLine(target.BaseSkinName + "Gain Buff" + args.BuffID);
        }
        static Program()
        {
        ...
        private static void BuffLost(Obj_AI_Base target, Obj_AI_Base source, Program.OnGainBuffArgs args)
        {
            Console.WriteLine(target.BaseSkinName + "Lost Buff" + args.BuffID);
        }
