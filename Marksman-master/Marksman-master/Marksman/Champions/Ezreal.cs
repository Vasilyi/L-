...
namespace Marksman.Champions
{
    ...
    internal class Ezreal : Champion
    {
        ...
        public static Obj_AI_Hero GetAATarget()
        {
            ...
            if (target != null && Marksman.Utils.Orbwalking.InAutoAttackRange(target))
            {
                return target;
            }
            return null;
        ...
        private static void CastQ()
        {
            ...
            if (t.IsValidTarget() && Q.IsReady() && ObjectManager.Player.Distance(t.ServerPosition) <= Q.Range && ShouldCast())
            {
