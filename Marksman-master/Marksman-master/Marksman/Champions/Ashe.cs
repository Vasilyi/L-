...
namespace Marksman.Champions
{
    internal class Ashe : Champion
    {
        ...
        {
            if (!Utils.Orbwalking.CanAttack(-250) && !Utils.Orbwalking.CanAttack() && Utils.Orbwalking.CanMove(0) && !ObjectManager.Player.Spellbook.IsCastingSpell)
            {
                return true;
            }
        ...
        public override void Game_OnGameUpdate(EventArgs args)
        {
            ...
            if (ComboActive)
            {
                ...
                if (useW && W.IsReady() && t.IsValidTarget() && ShouldCast())
                {
                    W.Cast(t);
                }
