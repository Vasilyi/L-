...
namespace Marksman.Champions
{
    internal class Kogmaw : Champion
    {
        ...
        public static bool ShouldCast()
        {
            ...
            var delay = bioArcaneActive ? 0 : -150;
            Console.WriteLine(delay);
            if ((!Utils.Orbwalking.CanAttack(delay) && !Utils.Orbwalking.CanAttack() && Utils.Orbwalking.CanMove(0) && !ObjectManager.Player.Spellbook.IsCastingSpell) || GetAATarget() == null)
            {
                return true;
            }
        ...
        private static void CastQ()
        {
            ...
            if (t.IsValidTarget() && Q.IsReady() &&
                ObjectManager.Player.Distance(t.ServerPosition) <= Q.Range && ShouldCast())
            {
        ...
        public override void Game_OnGameUpdate(EventArgs args)
        {
            ...
            var realaspeed = ObjectManager.Player.AttackSpeedMod * 0.665;
            var aspeedslider = GetValue<Slider>("aspeedcap").Value;
            Console.WriteLine(aspeedslider);
            if (realaspeed > aspeedslider/10 && GetAATarget() != null)
            {
            ...
            if (useR && R.IsReady() && UltiBuffStacks < rLim && ShouldCast())
            {
                var t = TargetSelector.GetTarget(R.Range, TargetSelector.DamageType.Magical);
                if (GetAATarget() != null)
                {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("aspeedcap" + Id, "Max orbwalk speed").SetValue(new Slider(25, 1, 50)));
