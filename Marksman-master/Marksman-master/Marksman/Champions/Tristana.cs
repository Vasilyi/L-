...
namespace Marksman.Champions
{
    internal class Tristana : Champion
    {
        ...
        {
            if ((!Utils.Orbwalking.CanAttack(-250) && !Utils.Orbwalking.CanAttack() && Utils.Orbwalking.CanMove(0) && !ObjectManager.Player.Spellbook.IsCastingSpell) || GetAATarget() == null)
            {
                return true;
            }
